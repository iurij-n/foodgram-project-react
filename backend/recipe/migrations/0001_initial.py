# Generated by Django 2.2 on 2022-06-15 17:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('recipe', models.ForeignKey(on_delete='cascade', to='recipe.Recipe')),
                ('tag', models.ForeignKey(on_delete='cascade', to='recipe.Tag')),
            ],
        ),
        migrations.CreateModel(
