...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='foodstuff',
            field=models.ForeignKey(help_text='Название продукта', on_delete=django.db.models.deletion.CASCADE, related_name='foodstuffs', to='recipe.Foodstuff', verbose_name='Название продукта'),
        ),
        migrations.AddField(
            model_name='ingredients',
            name='recipe_id',
